<?php	
	...
	if (isset($_POST['upload'])) {
		...
		$sql = "INSERT INTO clients (clients_picture) VALUES ('$image')";
		// execute query
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="">
                            <h3 style="font-size: 1.5em;" class="card-title">Add Clients Picture</h3>
                        </div>
                    </div>
                    ...
                    <div class="card-body card-block">
                        ...
                        <form method="post" action="" enctype='multipart/form-data'>
                            <div class="form-group">
                                <label for="catagory" class=" form-control-label">Choose Clients Picture</label>
