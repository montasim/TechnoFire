<?php
   ...
   if(isset($_GET['type']) && $_GET['type'] == 'delete' && isset($_GET['id'])){
      ...
      mysqli_query($db_connection,"delete from clients where id='$id'");
   }

   // "order by id desc" is used to show recent added catagory first
   $res = mysqli_query($db_connection,"SELECT * FROM `clients` ORDER BY `clients`.`id` desc");
?>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <div class="">
                            <h3 style="font-size: 1.5em;" class="card-title">Clients</h3>
                        </div>
                        <div class="">
                            <i class="mr-2 fa fa-plus-square"></i>
                            <a href="add_clients.php"><strong style="font-size: 1em;" class="card-title">Add
                                    Clients</strong></a>
                        </div>
                    </div>
                            ...
                            <table class="table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="10%">S.No</th>
                                        <th width="100%">Clients Picture</th>
                                 ...
                                 ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                   echo "<div id='img_div'>";
                                                      echo "<img src='upload/".$row['clients_picture']."' >";
                                                   echo "</div>";
                                             ?>
                                        </td>
                                        ...
                                        <td>
                                            <a href="clients.php?id=<?php echo $row['id']?>&type=delete">Delete</a>
                                        </td>
                                    </tr>
                                    <?php 
                                    $i++;
