    ...
    (l.VERSION = "1.12.4"),
      ...
      (l.prototype = {
        ...
        init: function () {
          ...
          (this.options.initInProcess = !0),
            "auto" === this.options.width &&
              !0 === this.options.lazyLoadLiElements &&
              (console.log(
              ...
              (this.options.lazyLoadLiElements = !1)),
            ...
            this.clickListener(),
            !0 === this.options.lazyLoadLiElements &&
              this.$button.one("click.dropdown.data-api", function (a) {
                (b.$lis = null),
                  (b.liObj = {}),
                  b.reloadLi(),
                  b.render(),
        ...
        render: function (b) {
          ...
          var f = function (b) {
              if (
                ...
                !(
                  b.disabled ||
                  ("OPTGROUP" === b.parentNode.tagName && b.parentNode.disabled)
                )
              ) {
                var c,
                  e = a(b),
                  f =
                    e.data("icon") && d.options.showIcon
                      ? '<i class="' +
                        d.options.iconBase +
                        " " +
                        e.data("icon") +
                ...
                return (
                  (c =
                    d.options.showSubtext && e.data("subtext") && !d.multiple
                      ? ' <small class="text-muted">' +
                        e.data("subtext") +
                        "</small>"
                      : ""),
                  void 0 !== e.attr("title")
                    ? e.attr("title")
                    : e.data("content") && d.options.showContent
            ...
            g =
              this.multiple || !0 !== this.options.singleSelectPerfTweak
                ? e
                    .map(function () {
                      if (this.selected) return f(this);
                    })
                    .toArray()
                : [f(this.$element[0][this.$element[0].selectedIndex])],
          ...
          if (
            ...
            if (
              (i.length > 1 && g.length > i[1]) ||
              (1 == i.length && g.length >= 2)
            ) {
              ...
              h = (
                "function" == typeof this.options.countSelectedText
                  ? this.options.countSelectedText(g.length, j)
                  : this.options.countSelectedText
              )
                .replace("{0}", g.length.toString())
                .replace("{1}", j.toString());
            }
          }
          void 0 == this.options.title &&
            ...
            this.$button.attr("title", k(a.trim(h.replace(/<[^>]*>?/g, "")))),
            this.$button.children(".filter-option").html(h),
            (this.options.initInProcess &&
              !0 === this.options.lazyLoadLiElements) ||
